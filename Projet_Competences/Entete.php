<?php
   function HEAD($title)
   {
    ...
    echo "<link type=\"text/css\" rel=\"stylesheet\" href=\"css1.css\">\n";
    echo "</head>\n";
   ...
   function HEAD2($title)
   {
    ...
    echo "<link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css\" integrity=\"sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z\" crossorigin=\"anonymous\">\n";
    echo "<script src=\"https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js\" integrity=\"sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV\" crossorigin=\"anonymous\"></script>\n";
    echo "<link type=\"text/css\" rel=\"stylesheet\" href=\"AdminCss.css\">\n";
    echo "</head>\n";
   ...
   echo "		<link href=\"AdminCss.css\" rel='stylesheet' type='text/css' />\n";
   echo "   		 <!-- Custom Theme files -->\n";
   echo "   		  <!---- start-smoth-scrolling---->";
   echo "		<script type=\"text/javascript\" src=\"move-top.js\"></script>\n";
   echo "		<script type=\"text/javascript\" src=\"easing.js\"></script>\n";
   echo "		<script type=\"text/javascript\">\n";
   echo "			jQuery(document).ready(function($) {\n";
   echo "				$(\".scroll\").click(function(event){	\n";	
   echo "					event.preventDefault();\n";
   echo "					$('html,body').animate({scrollTop:$(this.hash).offset().top},1500);\n";
   echo "				});\n";
   echo "			});\n";
   echo "		</script>\n";
   echo "		 <!---- start-smoth-scrolling---->\n";
   ...
   echo "		</script>\n";
   echo "		<!----start-top-nav-script---->\n";
   echo "		<script>\n";
   echo "			$(function() {\n";
   echo "				var pull 		= $('#pull');\n";
   echo "					menu 		= $('nav ul');\n";
   echo "					menuHeight	= menu.height();\n";
   echo "				$(pull).on('click', function(e) {\n";
   echo "					e.preventDefault();\n";
   echo "					menu.slideToggle();\n";
   echo "				});\n";
   echo "				$(window).resize(function(){\n";
   echo "	        		var w = $(window).width();\n";
   echo "	        		if(w > 320 && menu.is(':hidden')) {\n";
   echo "	        			menu.removeAttr('style');\n";
   echo "	        		}\n";
   echo "	    		});\n";
   echo "			});\n";
   echo "		</script>\n";
   echo "		<!----//End-top-nav-script---->\n";
