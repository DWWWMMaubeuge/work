...
<section class="content">
	<div class="colonne_centre page_contact">
		...
		<h1>Contactez votre psychologue près de Maubeuge</h1>
		...
		<div class="block_contact">
			...
			<div class="info_contact">
				<div class="coordonnees">
					...
					<div class="info_mail">
						<p>
							<script class="contact-odc-conseil-fr" type="text/javascript">
								//<![CDATA[
								var il = "";
								for (var l7 = 0; l7 < 276; l7++) il += String.fromCharCode(("t&p{76?k6???/wKp[uL\"t[x{k1|pk6=$~I{p\"t >[rt7jk1>v;?lk1ljr~8:k6\"p}\"$\"k6r\"$ {=\"t7>prt;j\">vj?k1k1lk1Ol8:~sk1:k6r~r< x{}#tt kk(A=\"u\"k6prt { >t7>k1k1v;jl8lj?T/:k6k1~}/Mr$5$pr?C2(?sr?J~}#<r~52tx{?C???\"KEJuMk6>pT {=\"t7>prt;k1T>v#%Zk1=\"7q#$@886=\"t {prt7>7==87===8>v;13A3@18=#%q#$\"7C88".charCodeAt(l7) - (-53 + 68) + 6 * 0 + 63) % (1 * 8 + 87) + 6 * 2 + 20);
								$(".contact-odc-conseil-fr:first").replaceWith(eval(il))
								//]]>
							</script>
						</p>
					</div>
			...
			<div class="formulaire_contact">
				...
				<form id="formulaire_1" onsubmit="return App.validate(this);" enctype="application/x-www-form-urlencoded" class="generateur" novalidate="true" action="/contact.php" method="post">
					...
					<div class="divGenerateurRequired"><span class="required">*</span>&nbsp;Champs requis</div>
				</form>
				<script type="text/javascript">
					...
					Forms.pays = 'FRANCE';
					Forms.formulaire_1 = {};
					Forms.formulaire_1.field_1 = [{
						name: 'Zend_Validate_NotEmpty',
						parameters: {}
					}];
					Forms.formulaire_1.field_3 = [{
						name: 'Zend_Validate_NotEmpty',
						parameters: {}
					}, {
						name: 'My_Zend_Validate_Telephone',
						parameters: {}
					}];
					Forms.formulaire_1.field_4 = [{
						name: 'Zend_Validate_NotEmpty',
						parameters: {}
					}, {
						name: 'My_Zend_Validate_EmailAddress',
						parameters: {}
					}];
					Forms.formulaire_1.field_14 = [{
						name: 'Zend_Validate_Digits',
						parameters: {}
					}];
					Forms.formulaire_1.field_11 = [{
						name: 'Zend_Validate_NotEmpty',
						parameters: {}
					}, {
						name: 'My_Zend_Validate_UrlExterne',
						parameters: {}
					}];
					Forms.formulaire_1.field_26 = [{
						name: 'Zend_Validate_NotEmpty',
						parameters: {}
					}, {
						name: 'Zend_Captcha_Image',
						parameters: {}
					}];
				</script>
			</div>
...
<div id="navigation_frame">
	<div class="lien_footer">
		...
		<ul>
			<li class="firstLi"><a href="/">Accueil</a></li>
			...
			<li class="firstLi"><a class="selected" href="contact.php">Contact</a></li>
