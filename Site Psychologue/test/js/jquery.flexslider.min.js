(function ($) {
  $.flexslider = function (el, options, instanceId) {
    ...
    methods = {
      init: function () {
        ...
        if (
          ...
          $(document).bind(
            "keyup" + slider.vars.eventNamespace + "-" + slider.id,
            function (event) {
        ...
        if (slider.vars.mousewheel)
          slider.bind(
            "mousewheel" + slider.vars.eventNamespace,
      ...
      asNav: {
        setup: function () {
          ...
          if (!msGesture)
            slider.slides.on(
              "click" + slider.vars.eventNamespace,
              function (e) {
                e.preventDefault();
                var $slide = $(this),
                  target = $slide.index();
          ...
          if (!touch)
            ...
            slider.slides
              .css({
                ...
                display: "block",
                webkitTransition:
                  "opacity " + slider.vars.animationSpeed / 1e3 + "s ease",
                zIndex: 1,
              })
              .eq(slider.currentSlide)
    ...
    slider.destroy = function () {
      ...
      if (slider.vars.animation == "slide") slider.container.unwrap();
      ...
      slider.slides
        ...
        .removeClass(slider.vars.namespace + "active-slide");
  ...
  $.fn.flexslider = function (options) {
    ...
    if (typeof options === "object")
      return this.each(function () {
        ...
        } else if ($this.data("flexslider") === undefined) new $.flexslider(this, options, instanceId++);
      });
    else {
