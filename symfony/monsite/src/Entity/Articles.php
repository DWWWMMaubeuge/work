...
class Articles
{
    ...
    public function getFearutedImage(): ?string
    {
        return $this->fearuted_image;
    }

    public function setFearutedImage(string $fearuted_image): self
    {
        $this->fearuted_image = $fearuted_image;
