...
$('#ajoutformation').submit(function(e) {
    ...
    $.ajax({
        ...
        type: 'POST',
        url: '../traitements/traitement-editformations.php',
        data: {
            
            'Ajout': $('#nomformation').val()
        },
        ...
        success: function(data) {
            ...
            $("#formations").load("../config/getformations.php");
...
// Envoi du formulaire de suppression d'une formation lorsque le SuperAdmin appuie sur le bouton d'envoi qui appelle ce script
$('#supprimerformation').submit(function(e) {
    
    //Ciblage de la div d'alertes
    let alertWindow = document.getElementById('notification');
    // Ciblage de l'input du nom de la formation à supprimer
    let myInput = document.getElementById('supprimer');
    // Annulation de l'action de base du formulaire
    e.preventDefault();
