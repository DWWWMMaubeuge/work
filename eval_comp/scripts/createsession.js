// Envoi du formulaire d'ajout d'une session lorsque le SuperAdmin appuie sur le bouton d'envoi qui appelle ce script
$('#addsession').submit(function(e) {
    ...
    $.ajax({
        ...
        // Envoi et réception des données au format texte
        dataType: 'text',
        // En cas de succès:
