...
if(!empty($_POST['Emails']) && !empty($_POST['Formation'])) {
    ...
    $feedback = "Veuillez renseigner une ou des adresse(s) e-mail ainsi que la formation dans lequel les utilisateurs doivent être invités !";
