...
if(isset($_SESSION['id'])) {
    ...
    // Si l'id d'un skill et sa valeur sont fournis en paramètres:
    if( $_GET['idSkill'] != "" && $_GET['valSkill'] != "") {
    
        GLOBAL $bdd;
        
        // On récupère les 3 premières lettres du mois en cours pour l'ajout dans la table des résultats
        $moisInsertion = substr($mois, 0, 3);
        // On récupère le reste des paramètres à insérer dans la table des résultats selon les valeurs passés et on les stockes dans des variables
